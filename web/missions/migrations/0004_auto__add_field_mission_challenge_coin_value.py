...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mission.challenge_coin_value'
        db.add_column('missions_mission', 'challenge_coin_value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mission.challenge_coin_value'
        db.delete_column('missions_mission', 'challenge_coin_value')
