...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mission.video'
        db.alter_column('missions_mission', 'video', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Mission.description'
        db.alter_column('missions_mission', 'description', self.gf('django.db.models.fields.TextField')(default=''))


    def backwards(self, orm):
        
        # Changing field 'Mission.video'
        db.alter_column('missions_mission', 'video', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Mission.description'
        db.alter_column('missions_mission', 'description', self.gf('django.db.models.fields.TextField')(null=True))
