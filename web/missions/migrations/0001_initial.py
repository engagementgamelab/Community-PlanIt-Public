...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('missions_mission', (
            ...
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='missions', to=orm['instances.Instance'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('video', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('missions', ['Mission'])


    def backwards(self, orm):
        # Deleting model 'Mission'
        db.delete_table('missions_mission')
