...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ValueTranslation'
        db.create_table('values_valuetranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['values.Value'])),
        ))
        db.send_create_signal('values', ['ValueTranslation'])

        # Adding unique constraint on 'ValueTranslation', fields ['language_code', 'master']
        db.create_unique('values_valuetranslation', ['language_code', 'master_id'])

        # Adding model 'Value'
        db.create_table('values_value', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coins', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='values', to=orm['instances.Instance'])),
        ))
        ...
        # Adding unique constraint on 'PlayerValue', fields ['user', 'value']
        db.create_unique('values_playervalue', ['user_id', 'value_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PlayerValue', fields ['user', 'value']
        db.delete_unique('values_playervalue', ['user_id', 'value_id'])

        # Removing unique constraint on 'ValueTranslation', fields ['language_code', 'master']
        db.delete_unique('values_valuetranslation', ['language_code', 'master_id'])

        # Deleting model 'ValueTranslation'
        db.delete_table('values_valuetranslation')
    ...
    models = {
        ...
        'values.playervalue': {
            'Meta': {'unique_together': "(('user', 'value'),)", 'object_name': 'PlayerValue'},
        ...
        'values.value': {
            ...
            'coins': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'values'", 'to': "orm['instances.Instance']"})
        },
        'values.valuetranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'ValueTranslation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['values.Value']"}),
