...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('issues_issue_comments', (
        ...
        db.create_unique('issues_issue_comments', ['issue_id', 'comment_id'])

        # Adding model 'PlayerIssue'
        db.create_table('issues_playerissue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('coins', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('issues', ['PlayerIssue'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('issues_issue_comments')

        # Deleting model 'PlayerIssue'
        db.delete_table('issues_playerissue')
