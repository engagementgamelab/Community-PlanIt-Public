...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValueTranslation.message'
        db.alter_column('values_valuetranslation', 'message', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ValueTranslation.message'
        db.alter_column('values_valuetranslation', 'message', self.gf('django.db.models.fields.CharField')(max_length=260))
