...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ValueTranslation.description'
        db.add_column('values_value_translation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ValueTranslation.description'
        db.delete_column('values_value_translation', 'description')
    ...
    models = {
        ...
        'values.valuetranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'ValueTranslation', 'db_table': "'values_value_translation'"},
