...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Value.message'
        db.delete_column('values_value', 'message')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Value.message'
        db.add_column('values_value', 'message', self.gf('django.db.models.fields.CharField')(default='', max_length=260), keep_default=False)
    ...
    models = {
        ...
        'values.valuetranslation': {
            'Meta': {'ordering': "('message',)", 'unique_together': "[('language_code', 'master')]", 'object_name': 'ValueTranslation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
