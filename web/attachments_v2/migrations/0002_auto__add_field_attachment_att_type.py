...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attachment.att_type'
        db.add_column('attachments_attachment', 'att_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attachment.att_type'
        db.delete_column('attachments_attachment', 'att_type')
