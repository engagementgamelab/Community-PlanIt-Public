...
urlpatterns = patterns('',
    ...
    (r'^communities/', include('web.instances.urls', namespace='communities', app_name='instances')),
    ...
    (r"^activities/", include("web.player_activities.urls", namespace='activities', app_name='activities')),
