...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BadgePerPlayer', fields ['badge', 'user']
        db.create_unique('badges_badgeperplayer', ['badge_id', 'user_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'BadgePerPlayer', fields ['badge', 'user']
        db.delete_unique('badges_badgeperplayer', ['badge_id', 'user_id'])
    ...
    models = {
        ...
        'badges.badgeperplayer': {
            'Meta': {'unique_together': "(('badge', 'user'),)", 'object_name': 'BadgePerPlayer'},
