...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnswerChoice.trivia_correct_answer'
        db.delete_column('challenges_answerchoice', 'trivia_correct_answer')

        # Adding field 'AnswerChoice.is_barrier_correct_answer'
        db.add_column('challenges_answerchoice', 'is_barrier_correct_answer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AnswerChoice.trivia_correct_answer'
        db.add_column('challenges_answerchoice', 'trivia_correct_answer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'AnswerChoice.is_barrier_correct_answer'
        db.delete_column('challenges_answerchoice', 'is_barrier_correct_answer')
