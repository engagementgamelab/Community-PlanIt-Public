...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FinalBarrierChallenge'
        db.create_table('challenges_finalbarrierchallenge', (
        ...
        db.send_create_signal('challenges', ['FinalBarrierChallenge'])


    def backwards(self, orm):
        # Deleting model 'FinalBarrierChallenge'
        db.delete_table('challenges_finalbarrierchallenge')
