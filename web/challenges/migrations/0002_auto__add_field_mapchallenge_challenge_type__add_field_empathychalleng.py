...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapChallenge.challenge_type'
        db.add_column('player_activities_playermapactivity', 'challenge_type',
                      self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'EmpathyChallenge.challenge_type'
        db.add_column('player_activities_playerempathyactivity', 'challenge_type',
                      self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'Challenge.challenge_type'
        db.add_column('player_activities_playeractivity', 'challenge_type',
                      self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapChallenge.challenge_type'
        db.delete_column('player_activities_playermapactivity', 'challenge_type')

        # Deleting field 'EmpathyChallenge.challenge_type'
        db.delete_column('player_activities_playerempathyactivity', 'challenge_type')

        # Deleting field 'Challenge.challenge_type'
        db.delete_column('player_activities_playeractivity', 'challenge_type')
