...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.polymorphic_ctype'
        db.add_column('challenges_answer', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_challenges.answer_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Answer.polymorphic_ctype'
        db.delete_column('challenges_answer', 'polymorphic_ctype_id')
    ...
    models = {
        ...
        'challenges.answer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_challenges.answer_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
        ...
        'challenges.answerwithmultiplechoices': {
            'Meta': {'object_name': 'AnswerWithMultipleChoices', '_ormbases': ['challenges.Answer']},
            'answer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['challenges.Answer']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'challenges.answerwithonechoice': {
            'Meta': {'object_name': 'AnswerWithOneChoice', '_ormbases': ['challenges.Answer']},
            'answer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['challenges.Answer']", 'unique': 'True', 'primary_key': 'True'}),
