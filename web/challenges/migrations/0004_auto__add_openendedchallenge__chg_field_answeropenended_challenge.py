...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OpenEndedChallenge'
        db.create_table('challenges_openendedchallenge', (
        ...
        db.send_create_signal('challenges', ['OpenEndedChallenge'])


        # Changing field 'AnswerOpenEnded.challenge'
        db.alter_column('challenges_answeropenended', 'challenge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.OpenEndedChallenge']))

    def backwards(self, orm):
        # Deleting model 'OpenEndedChallenge'
        db.delete_table('challenges_openendedchallenge')


        # Changing field 'AnswerOpenEnded.challenge'
        db.alter_column('challenges_answeropenended', 'challenge_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['challenges.Challenge']))
