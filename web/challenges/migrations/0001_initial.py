...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PlayerChallenge', fields ['player', 'challenge']
        db.create_unique('challenges_playerchallenge', ['player_id', 'challenge_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'PlayerChallenge', fields ['player', 'challenge']
        db.delete_unique('challenges_playerchallenge', ['player_id', 'challenge_id'])
    ...
    models = {
        ...
        'challenges.playerchallenge': {
            'Meta': {'unique_together': "(('player', 'challenge'),)", 'object_name': 'PlayerChallenge'},
