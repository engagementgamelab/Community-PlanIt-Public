...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnswerWithChoices.activity'
        db.delete_column('challenges_answerwithchoices', 'activity_id')

        # Adding field 'AnswerWithChoices.challenge'
        db.add_column('challenges_answerwithchoices', 'challenge',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='singleresponse_answers', to=orm['challenges.Challenge']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AnswerWithChoices.activity'
        raise RuntimeError("Cannot reverse this migration. 'AnswerWithChoices.activity' and its values cannot be restored.")
        # Deleting field 'AnswerWithChoices.challenge'
        db.delete_column('challenges_answerwithchoices', 'challenge_id')
