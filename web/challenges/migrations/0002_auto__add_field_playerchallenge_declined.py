...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerChallenge.declined'
        db.add_column('challenges_playerchallenge', 'declined', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlayerChallenge.declined'
        db.delete_column('challenges_playerchallenge', 'declined')
