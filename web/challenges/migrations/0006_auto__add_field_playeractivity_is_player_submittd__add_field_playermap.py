...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerActivity.is_player_submittd'
        db.add_column('player_activities_playeractivity', 'is_player_submittd',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlayerMapActivity.is_player_submittd'
        db.add_column('player_activities_playermapactivity', 'is_player_submittd',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlayerEmpathyActivity.is_player_submittd'
        db.add_column('player_activities_playerempathyactivity', 'is_player_submittd',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PlayerActivity.is_player_submittd'
        db.delete_column('player_activities_playeractivity', 'is_player_submittd')

        # Deleting field 'PlayerMapActivity.is_player_submittd'
        db.delete_column('player_activities_playermapactivity', 'is_player_submittd')

        # Deleting field 'PlayerEmpathyActivity.is_player_submittd'
        db.delete_column('player_activities_playerempathyactivity', 'is_player_submittd')
    ...
    models = {
        ...
        'player_activities.playeractivity': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_player_submittd': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
