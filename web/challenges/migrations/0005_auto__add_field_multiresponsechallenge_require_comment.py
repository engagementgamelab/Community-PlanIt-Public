...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MultiResponseChallenge.require_comment'
        db.add_column('challenges_multiresponsechallenge', 'require_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MultiResponseChallenge.require_comment'
        db.delete_column('challenges_multiresponsechallenge', 'require_comment')
