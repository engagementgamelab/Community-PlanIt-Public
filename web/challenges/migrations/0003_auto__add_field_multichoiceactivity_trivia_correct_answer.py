...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MultiChoiceActivity.trivia_correct_answer'
        db.add_column('player_activities_multichoiceactivity', 'trivia_correct_answer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MultiChoiceActivity.trivia_correct_answer'
        db.delete_column('player_activities_multichoiceactivity', 'trivia_correct_answer')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 17, 9, 58, 23, 203275)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 17, 9, 58, 23, 203178)'}),
