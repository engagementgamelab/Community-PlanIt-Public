...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Challenge.mission'
        db.delete_column('challenges_challenge', 'mission_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Challenge.mission'
        raise RuntimeError("Cannot reverse this migration. 'Challenge.mission' and its values cannot be restored.")
