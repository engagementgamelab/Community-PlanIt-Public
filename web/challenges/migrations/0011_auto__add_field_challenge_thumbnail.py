...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Challenge.thumbnail'
        db.add_column('challenges_challenge', 'thumbnail',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Challenge.thumbnail'
        db.delete_column('challenges_challenge', 'thumbnail')
