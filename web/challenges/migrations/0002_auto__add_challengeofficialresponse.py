...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChallengeOfficialResponse'
        db.create_table('challenges_challengeofficialresponse', (
        ...
        db.send_create_signal('challenges', ['ChallengeOfficialResponse'])


    def backwards(self, orm):
        
        # Deleting model 'ChallengeOfficialResponse'
        db.delete_table('challenges_challengeofficialresponse')
    ...
    models = {
        ...
        'challenges.challengeofficialresponse': {
            'Meta': {'object_name': 'ChallengeOfficialResponse'},
            'challenge': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['challenges.Challenge']", 'unique': 'True'}),
