...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayerFlag'
        db.create_table('flags_playerflag', (
        ...
        db.send_create_signal('flags', ['PlayerFlag'])


    def backwards(self, orm):
        
        # Deleting model 'PlayerFlag'
        db.delete_table('flags_playerflag')
