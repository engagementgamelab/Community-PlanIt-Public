...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.thumbnail'
        db.add_column('attachments_attachment', 'thumbnail',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Attachment.thumbnail'
        db.delete_column('attachments_attachment', 'thumbnail')
