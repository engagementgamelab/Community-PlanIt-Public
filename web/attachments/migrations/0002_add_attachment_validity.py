...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attachment.is_valid'
        db.add_column('attachments_attachment', 'is_valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Attachment.last_validity_check'
        db.add_column('attachments_attachment', 'last_validity_check', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attachment.is_valid'
        db.delete_column('attachments_attachment', 'is_valid')
