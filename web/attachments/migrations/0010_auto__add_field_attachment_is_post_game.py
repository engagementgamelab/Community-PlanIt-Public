...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.is_post_game'
        db.add_column('attachments_attachment', 'is_post_game',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Attachment.is_post_game'
        db.delete_column('attachments_attachment', 'is_post_game')
