...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field comments_old on 'OtherShoes'
        db.delete_table('games_othershoes_comments_old')


    def backwards(self, orm):
        
        # Adding M2M table for field comments_old on 'OtherShoes'
        db.create_table('games_othershoes_comments_old', (
        ...
        db.create_unique('games_othershoes_comments_old', ['othershoes_id', 'comment_id'])
