...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('games_othershoes_comments', 'games_othershoes_comments_old')

    def backwards(self, orm):
        try:
            db.rename_table('games_othershoes_comments_old', 'games_othershoes_comments')
        except:
            # the old comments table will be deleted after the data migration,
            pass
