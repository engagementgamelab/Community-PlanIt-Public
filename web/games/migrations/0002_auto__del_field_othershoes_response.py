...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OtherShoes.response'
        db.delete_column('games_othershoes', 'response_id')

        # Adding M2M table for field comments on 'OtherShoes'
        db.create_table('games_othershoes_comments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('othershoes', models.ForeignKey(orm['games.othershoes'], null=False)),
            ('comment', models.ForeignKey(orm['comments.comment'], null=False))
        ))
        db.create_unique('games_othershoes_comments', ['othershoes_id', 'comment_id'])


    def backwards(self, orm):
        
        # Adding field 'OtherShoes.response'
        db.add_column('games_othershoes', 'response', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['responses.CommentResponse'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field comments on 'OtherShoes'
        db.delete_table('games_othershoes_comments')
