...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('comments_comment', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='content_type_set_for_comment', null=True, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Comment.object_id'
        db.add_column('comments_comment', 'object_id', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Comment.posted_date'
        db.alter_column('comments_comment', 'posted_date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Deleting field 'Comment.content_type'
        db.delete_column('comments_comment', 'content_type_id')

        # Deleting field 'Comment.object_id'
        db.delete_column('comments_comment', 'object_id')

        # Changing field 'Comment.posted_date'
        db.alter_column('comments_comment', 'posted_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
