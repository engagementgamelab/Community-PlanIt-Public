...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.message'
        db.alter_column('comments_comment', 'message', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'Comment.message'
        db.alter_column('comments_comment', 'message', self.gf('django.db.models.fields.CharField')(max_length=140))
