...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Comment.message'
        db.delete_column('comments_comment', 'message')

        # Changing field 'CommentTranslation.message'
        db.alter_column('comments_commenttranslation', 'message', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Comment.message'
        raise RuntimeError("Cannot reverse this migration. 'Comment.message' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CommentTranslation.message'
        raise RuntimeError("Cannot reverse this migration. 'CommentTranslation.message' and its values cannot be restored.")
    ...
    models = {
        ...
        'comments.comment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['instances.Instance']", 'null': 'True'}),
