...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.instance'
        db.alter_column('comments_comment', 'instance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instances.Instance'], null=True))

        # Changing field 'Comment.user'
        db.alter_column('comments_comment', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Comment.instance'
        raise RuntimeError("Cannot reverse this migration. 'Comment.instance' and its values cannot be restored.")
