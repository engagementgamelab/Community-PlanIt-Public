...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        #[u'chart', u'video', u'picture', u'', u'graph', u'image']
        for a in orm.Attachment.objects.all():
            if a.type == 'chart':
                a.att_type = Attachment.ATTACHMENT_TYPE_CHART
            elif a.type == 'video':
                a.att_type = Attachment.ATTACHMENT_TYPE_VIDEO
            elif a.type == 'picture':
                a.att_type = Attachment.ATTACHMENT_TYPE_PICTURE
            elif a.type == 'graph':
                a.att_type = Attachment.ATTACHMENT_TYPE_GRAPH
            elif a.type == 'image':
                a.att_type = Attachment.ATTACHMENT_TYPE_IMAGE
            a.save()
