...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.is_resource_center'
        db.add_column('attachments_attachment', 'is_resource_center',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Attachment.is_resource_center'
        db.delete_column('attachments_attachment', 'is_resource_center')
