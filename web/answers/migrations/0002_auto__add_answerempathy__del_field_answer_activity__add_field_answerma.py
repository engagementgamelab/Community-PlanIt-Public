...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('answers_answerempathy', (
            ...
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='empathy_answers', to=orm['player_activities.PlayerEmpathyActivity'])),
        ))
        db.send_create_signal('answers', ['AnswerEmpathy'])

        # Deleting field 'Answer.activity'
        db.delete_column('answers_answer', 'activity_id')

        # Adding field 'AnswerMap.activity'
        db.add_column('answers_answermap', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='map_answers', to=orm['player_activities.PlayerMapActivity']), keep_default=False)

        # Adding field 'AnswerSingleResponse.activity'
        db.add_column('answers_answersingleresponse', 'activity', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='single_response_answers', to=orm['player_activities.PlayerActivity']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Answer.activity'
        raise RuntimeError("Cannot reverse this migration. 'Answer.activity' and its values cannot be restored.")

        # Deleting field 'AnswerMap.activity'
        db.delete_column('answers_answermap', 'activity_id')

        # Deleting field 'AnswerSingleResponse.activity'
        db.delete_column('answers_answersingleresponse', 'activity_id')
    ...
    models = {
        ...
        'answers.answersingleresponse': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'single_response_answers'", 'to': "orm['player_activities.PlayerActivity']"}),
            'answer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['answers.Answer']", 'unique': 'True', 'primary_key': 'True'}),
