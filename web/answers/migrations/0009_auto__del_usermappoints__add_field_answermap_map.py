...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('answers_answermap', 'map', self.gf('gmapsfield.fields.GoogleMapsField')(default=None, max_length=1000), keep_default=False)
    ...
    models = {
        ...
        'answers.answermap': {
            ...
            'answer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['answers.Answer']", 'unique': 'True', 'primary_key': 'True'}),
            'map': ('gmapsfield.fields.GoogleMapsField', [], {'max_length': '1000'})
        },
