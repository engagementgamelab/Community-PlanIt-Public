...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnswerOpenEnded.answerbox'
        db.delete_column('answers_answeropenended', 'answerbox')

        # Adding field 'AnswerOpenEnded.answerBox'
        db.add_column('answers_answeropenended', 'answerBox', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000), keep_default=False)
