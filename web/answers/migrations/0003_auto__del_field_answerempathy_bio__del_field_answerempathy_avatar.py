...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnswerEmpathy.bio'
        db.delete_column('answers_answerempathy', 'bio')

        # Deleting field 'AnswerEmpathy.avatar'
        db.delete_column('answers_answerempathy', 'avatar')


    def backwards(self, orm):
        
        # Adding field 'AnswerEmpathy.bio'
        db.add_column('answers_answerempathy', 'bio', self.gf('django.db.models.fields.CharField')(default=None, max_length=255), keep_default=False)

        # Adding field 'AnswerEmpathy.avatar'
        db.add_column('answers_answerempathy', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
