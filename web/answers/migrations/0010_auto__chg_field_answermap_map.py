...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerMap.map'
        db.alter_column('answers_answermap', 'map', self.gf('gmapsfield.fields.GoogleMapsField')())


    def backwards(self, orm):
        
        # Changing field 'AnswerMap.map'
        db.alter_column('answers_answermap', 'map', self.gf('gmapsfield.fields.GoogleMapsField')(max_length=1000))
