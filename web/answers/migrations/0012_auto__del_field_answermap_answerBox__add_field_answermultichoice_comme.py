...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnswerMap.answerBox'
        db.delete_column('answers_answermap', 'answerBox')

        # Adding field 'AnswerMultiChoice.comment'
        db.add_column('answers_answermultichoice', 'comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'AnswerMap.answerBox'
        db.add_column('answers_answermap', 'answerBox', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Deleting field 'AnswerMultiChoice.comment'
        db.delete_column('answers_answermultichoice', 'comment_id')
