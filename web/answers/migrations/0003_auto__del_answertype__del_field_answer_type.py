...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('answers_answer', 'type_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('answers_answer', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['answers.AnswerType']), keep_default=False)
