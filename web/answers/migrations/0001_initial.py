...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('answers_answertype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('defaultPoints', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('answers', ['AnswerType'])
        ...
        db.create_table('answers_answer', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['answers.AnswerType'])),
        ...
        # Adding model 'MultiChoiceOption'
        db.create_table('answers_multichoiceoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['answers.Answer'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('answers', ['MultiChoiceOption'])
        ...
        db.create_table('answers_answersingleresponse', (
            ('answer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['answers.Answer'], unique=True, primary_key=True)),
            ('selected', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['answers.MultiChoiceOption'])),
        ))
        ...
        db.create_table('answers_answermultichoice', (
            ...
            ('option', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['answers.MultiChoiceOption'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('answers_answertype')

        # Deleting model 'Answer'
        db.delete_table('answers_answer')

        # Deleting model 'MultiChoiceOption'
        db.delete_table('answers_multichoiceoption')
    ...
    models = {
        ...
        'answers.answertype': {
            ...
            'defaultPoints': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
