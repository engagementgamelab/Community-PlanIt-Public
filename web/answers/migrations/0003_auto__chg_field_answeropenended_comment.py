...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'AnswerOpenEnded.comment' to match new field type.
        db.rename_column('answers_answeropenended', 'comment_id', 'comment')
        # Changing field 'AnswerOpenEnded.comment'
        db.alter_column('answers_answeropenended', 'comment', self.gf('django.db.models.fields.TextField')())

        # Removing index on 'AnswerOpenEnded', fields ['comment']
        db.delete_index('answers_answeropenended', ['comment_id'])


    def backwards(self, orm):
        
        # Adding index on 'AnswerOpenEnded', fields ['comment']
        db.create_index('answers_answeropenended', ['comment_id'])

        # Renaming column for 'AnswerOpenEnded.comment' to match new field type.
        db.rename_column('answers_answeropenended', 'comment', 'comment_id')
        # Changing field 'AnswerOpenEnded.comment'
        db.alter_column('answers_answeropenended', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment']))
    ...
    models = {
        ...
        'answers.answeropenended': {
            ...
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'open_endedresponse_answers'", 'to': "orm['player_activities.PlayerActivity']"}),
            'answer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['answers.Answer']", 'unique': 'True', 'primary_key': 'True'}),
