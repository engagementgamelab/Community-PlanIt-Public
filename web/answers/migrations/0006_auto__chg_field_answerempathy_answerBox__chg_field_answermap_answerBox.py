...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AnswerEmpathy.answerBox'
        db.alter_column('answers_answerempathy', 'answerBox', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'AnswerMap.answerBox'
        db.alter_column('answers_answermap', 'answerBox', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Deleting field 'Answer.addInstructions'
        db.delete_column('answers_answer', 'addInstructions')

        # Deleting field 'Answer.instructions'
        db.delete_column('answers_answer', 'instructions')


    def backwards(self, orm):
        
        # Changing field 'AnswerEmpathy.answerBox'
        db.alter_column('answers_answerempathy', 'answerBox', self.gf('django.db.models.fields.TextField')())

        # Changing field 'AnswerMap.answerBox'
        db.alter_column('answers_answermap', 'answerBox', self.gf('django.db.models.fields.TextField')(null=True))

        # Adding field 'Answer.addInstructions'
        db.add_column('answers_answer', 'addInstructions', self.gf('django.db.models.fields.CharField')(default=None, max_length=255), keep_default=False)

        # Adding field 'Answer.instructions'
        db.add_column('answers_answer', 'instructions', self.gf('django.db.models.fields.CharField')(default=None, max_length=255), keep_default=False)
