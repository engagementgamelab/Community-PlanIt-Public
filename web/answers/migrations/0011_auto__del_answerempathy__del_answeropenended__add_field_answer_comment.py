...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.comment'
        db.add_column('answers_answer', 'comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment'], null=True, blank=True), keep_default=False)

        # Adding field 'Answer.createDate'
        db.add_column('answers_answer', 'createDate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 8, 18, 11, 15, 7, 791157)), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('answers_answerempathy', (
            ('answerBox', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ...
        # Deleting field 'Answer.comment'
        db.delete_column('answers_answer', 'comment_id')

        # Deleting field 'Answer.createDate'
        db.delete_column('answers_answer', 'createDate')


    models = {
        'answers.answer': {
            'Meta': {'object_name': 'Answer'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'answers'", 'to': "orm['player_activities.PlayerActivity']"}),
