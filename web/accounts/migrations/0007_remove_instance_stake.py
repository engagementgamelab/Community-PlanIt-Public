...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'stake', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['instances.Stake'], null=True, blank=True), keep_default=False)
