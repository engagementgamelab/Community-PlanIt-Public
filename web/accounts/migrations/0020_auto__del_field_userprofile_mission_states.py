...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field mission_states on 'UserProfile'
        db.create_table('accounts_userprofile_mission_states', (
        ...
        db.create_unique('accounts_userprofile_mission_states', ['userprofile_id', 'playermissionstate_id'])


    def backwards(self, orm):
        # Adding field 'UserProfile.mission_states'
        db.add_column('accounts_userprofile', 'mission_states',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='players', null=True, to=orm['accounts.PlayerMissionState'], blank=True),
                      keep_default=False)

        # Removing M2M table for field mission_states on 'UserProfile'
        db.delete_table('accounts_userprofile_mission_states')
