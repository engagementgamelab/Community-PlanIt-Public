...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field locked on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_locked', (
        ...
        db.create_unique('accounts_playermissionstate_locked', ['playermissionstate_id', 'challenge_id'])

        # Adding M2M table for field unlocked on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_unlocked', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playermissionstate', models.ForeignKey(orm['accounts.playermissionstate'], null=False)),
            ('challenge', models.ForeignKey(orm['challenges.challenge'], null=False))
        ))
        db.create_unique('accounts_playermissionstate_unlocked', ['playermissionstate_id', 'challenge_id'])

        # Adding M2M table for field completed on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_completed', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playermissionstate', models.ForeignKey(orm['accounts.playermissionstate'], null=False)),
            ('challenge', models.ForeignKey(orm['challenges.challenge'], null=False))
        ))
        db.create_unique('accounts_playermissionstate_completed', ['playermissionstate_id', 'challenge_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field locked on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_locked')

        # Removing M2M table for field unlocked on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_unlocked')

        # Removing M2M table for field completed on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_completed')
    ...
    models = {
        ...
        'accounts.playermissionstate': {
            ...
            'completed': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'challenges_completed'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['challenges.Challenge']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'challenges_locked'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['challenges.Challenge']"}),
            'mission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mission_states'", 'to': "orm['missions.Mission']"}),
            'unlocked': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'challenges_unlocked'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['challenges.Challenge']"}),
