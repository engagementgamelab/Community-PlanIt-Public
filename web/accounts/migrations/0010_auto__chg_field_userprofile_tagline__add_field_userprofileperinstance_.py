...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.tagline'
        db.alter_column('accounts_userprofile', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=140))
        # Adding field 'UserProfilePerInstance.date_created'
        db.add_column('accounts_userprofileperinstance', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 23, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # Changing field 'UserProfile.tagline'
        db.alter_column('accounts_userprofile', 'tagline', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Deleting field 'UserProfilePerInstance.date_created'
        db.delete_column('accounts_userprofileperinstance', 'date_created')
    ...
    models = {
        ...
        'accounts.userprofileperinstance': {
            ...
            'affils': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'affiliations'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['instances.Affiliation']"}),
