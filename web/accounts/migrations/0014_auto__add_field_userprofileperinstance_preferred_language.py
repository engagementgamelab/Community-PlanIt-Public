...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfilePerInstance.preferred_language'
        db.add_column('accounts_userprofileperinstance', 'preferred_language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['instances.Language']),
                      keep_default=False)
