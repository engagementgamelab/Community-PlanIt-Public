...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerMissionState.user'
        db.add_column('accounts_playermissionstate', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='mission_states', to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlayerMissionState.user'
        db.delete_column('accounts_playermissionstate', 'user_id')
