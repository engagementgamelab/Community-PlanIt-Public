...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.how_discovered_other'
        #db.alter_column('accounts_userprofile', 'how_discovered_other', self.gf('django.db.models.fields.CharField')(max_length=1000))
    def backwards(self, orm):
        # Adding field 'UserProfile.preferred_language'
        db.add_column('accounts_userprofile', 'preferred_language',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=5),
                      keep_default=False)


        # Changing field 'UserProfile.how_discovered_other'
        #db.alter_column('accounts_userprofile', 'how_discovered_other', self.gf('django.db.models.fields.CharField')(max_length=128))
    models = {
