...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('accounts_userprofile', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))
        # Deleting field 'UserProfilePerInstance.preferred_language'
        db.delete_column('accounts_userprofileperinstance', 'preferred_language_id')


    def backwards(self, orm):

        # Changing field 'UserProfile.avatar'
        db.alter_column('accounts_userprofile', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # User chose to not deal with backwards NULL issues for 'UserProfilePerInstance.preferred_language'
        raise RuntimeError("Cannot reverse this migration. 'UserProfilePerInstance.preferred_language' and its values cannot be restored.")
