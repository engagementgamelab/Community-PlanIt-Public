...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.receaveEmail'
        db.add_column('accounts_userprofile', 'receaveEmail', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.receaveEmail'
        db.delete_column('accounts_userprofile', 'receaveEmail')
    ...
    models = {
        'accounts.userprofile': {
            ...
            'receaveEmail': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
