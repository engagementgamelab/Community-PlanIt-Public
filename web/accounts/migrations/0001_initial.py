...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_userprofile', (
            ...
            ('points_multiplier', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('location_tracking', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('is_of_age', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('stake', self.gf('django.db.models.fields.CharField')(max_length=125, null=True, blank=True)),
            ('generated_password', self.gf('django.db.models.fields.CharField')(max_length=260)),
