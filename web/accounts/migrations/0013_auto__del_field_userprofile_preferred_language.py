...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'preferred_language_id')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.preferred_language'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.preferred_language' and its values cannot be restored.")
    models = {
