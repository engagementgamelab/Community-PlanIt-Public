...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.mission_states'
        db.add_column('accounts_userprofile', 'mission_states',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='players', null=True, to=orm['accounts.PlayerMissionState']),
                      keep_default=False)

        # Deleting field 'PlayerMissionState.profile_per_instance'
        db.delete_column('accounts_playermissionstate', 'profile_per_instance_id')

        # Deleting field 'PlayerMissionState.next_unlocked_barrier'
        db.delete_column('accounts_playermissionstate', 'next_unlocked_barrier_id')


    def backwards(self, orm):
        # Deleting field 'UserProfile.mission_states'
        db.delete_column('accounts_userprofile', 'mission_states_id')


        # User chose to not deal with backwards NULL issues for 'PlayerMissionState.profile_per_instance'
        raise RuntimeError("Cannot reverse this migration. 'PlayerMissionState.profile_per_instance' and its values cannot be restored.")
        # Adding field 'PlayerMissionState.next_unlocked_barrier'
        db.add_column('accounts_playermissionstate', 'next_unlocked_barrier',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='next_unlocked_barriers', unique=True, null=True, to=orm['challenges.Challenge'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'accounts.userprofile': {
            ...
            'instances': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'players'", 'to': "orm['instances.Instance']", 'through': "orm['accounts.UserProfilePerInstance']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'mission_states': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'players'", 'null': 'True', 'to': "orm['accounts.PlayerMissionState']"}),
