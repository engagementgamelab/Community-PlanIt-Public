...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlayerMissionState.locked'
        db.add_column('accounts_playermissionstate', 'locked',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'PlayerMissionState.unlocked'
        db.add_column('accounts_playermissionstate', 'unlocked',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'PlayerMissionState.completed'
        db.add_column('accounts_playermissionstate', 'completed',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'PlayerMissionState.barriers_fifty_fifty'
        db.add_column('accounts_playermissionstate', 'barriers_fifty_fifty',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Removing M2M table for field barriers_fifty_fifty on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_barriers_fifty_fifty')
    ...
    def backwards(self, orm):
        # Deleting field 'PlayerMissionState.locked'
        db.delete_column('accounts_playermissionstate', 'locked')

        # Deleting field 'PlayerMissionState.unlocked'
        db.delete_column('accounts_playermissionstate', 'unlocked')

        # Deleting field 'PlayerMissionState.completed'
        db.delete_column('accounts_playermissionstate', 'completed')

        # Deleting field 'PlayerMissionState.barriers_fifty_fifty'
        db.delete_column('accounts_playermissionstate', 'barriers_fifty_fifty')

        # Adding M2M table for field barriers_fifty_fifty on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_barriers_fifty_fifty', (
        ...
        db.create_unique('accounts_playermissionstate_barriers_fifty_fifty', ['playermissionstate_id', 'challenge_id'])
    ...
    models = {
        ...
        'accounts.playermissionstate': {
            ...
            'barriers_fifty_fifty': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'coins': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'completed': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'mission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mission_states'", 'to': "orm['missions.Mission']"}),
            'unlocked': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
