...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_playermissionstate', 'locked',
                      self.gf('web.core.csv_field.CSVField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'accounts.playermissionstate': {
            ...
            'barriers_fifty_fifty': ('web.core.csv_field.CSVField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'coins': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'completed': ('web.core.csv_field.CSVField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locked': ('web.core.csv_field.CSVField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'mission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mission_states'", 'to': "orm['missions.Mission']"}),
            'unlocked': ('web.core.csv_field.CSVField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
