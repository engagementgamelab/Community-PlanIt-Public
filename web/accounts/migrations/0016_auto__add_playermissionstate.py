...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_playermissionstate', (
            ...
            ('profile_per_instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='player_mission_states', to=orm['accounts.UserProfilePerInstance'])),
            ('mission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='challenges', to=orm['missions.Mission'])),
            ('next_unlocked_barrier', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='next_unlocked_barriers', unique=True, null=True, to=orm['challenges.Challenge'])),
            ('coins', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('accounts', ['PlayerMissionState'])

        # Adding M2M table for field challenges_completed on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_challenges_completed', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playermissionstate', models.ForeignKey(orm['accounts.playermissionstate'], null=False)),
            ('challenge', models.ForeignKey(orm['challenges.challenge'], null=False))
        ))
        db.create_unique('accounts_playermissionstate_challenges_completed', ['playermissionstate_id', 'challenge_id'])

        # Adding M2M table for field challenges_locked on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_challenges_locked', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playermissionstate', models.ForeignKey(orm['accounts.playermissionstate'], null=False)),
            ('challenge', models.ForeignKey(orm['challenges.challenge'], null=False))
        ))
        db.create_unique('accounts_playermissionstate_challenges_locked', ['playermissionstate_id', 'challenge_id'])

        # Adding M2M table for field challenges_unlocked on 'PlayerMissionState'
        db.create_table('accounts_playermissionstate_challenges_unlocked', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playermissionstate', models.ForeignKey(orm['accounts.playermissionstate'], null=False)),
            ('challenge', models.ForeignKey(orm['challenges.challenge'], null=False))
        ))
        db.create_unique('accounts_playermissionstate_challenges_unlocked', ['playermissionstate_id', 'challenge_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field challenges_completed on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_challenges_completed')

        # Removing M2M table for field challenges_locked on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_challenges_locked')

        # Removing M2M table for field challenges_unlocked on 'PlayerMissionState'
        db.delete_table('accounts_playermissionstate_challenges_unlocked')
    ...
    models = {
        ...
        'accounts.playermissionstate': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'challenges'", 'to': "orm['missions.Mission']"}),
        ...
        'accounts.userprofileeducationtranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileEducationTranslation', 'db_table': "'accounts_userprofileeducation_translation'"},
        ...
        'accounts.userprofilegendertranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileGenderTranslation', 'db_table': "'accounts_userprofilegender_translation'"},
        ...
        'accounts.userprofilehowdiscoveredtranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileHowDiscoveredTranslation', 'db_table': "'accounts_userprofilehowdiscovered_translation'"},
        ...
        'accounts.userprofileincometranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileIncomeTranslation', 'db_table': "'accounts_userprofileincome_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'accounts.userprofilelivingsituationtranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileLivingSituationTranslation', 'db_table': "'accounts_userprofilelivingsituation_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
        ...
        'accounts.userprofileracetranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileRaceTranslation', 'db_table': "'accounts_userprofilerace_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
        ...
        'accounts.userprofilestaketranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'UserProfileStakeTranslation', 'db_table': "'accounts_userprofilestake_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
