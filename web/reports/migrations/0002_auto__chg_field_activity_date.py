...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('reports_activity', 'date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Activity.date'
        db.alter_column('reports_activity', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
