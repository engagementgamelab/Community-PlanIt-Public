...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.action'
        db.alter_column('reports_activity', 'action', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Activity.action'
        db.alter_column('reports_activity', 'action', self.gf('django.db.models.fields.CharField')(max_length=48))
