...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('causes_cause', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60),
                      keep_default=False)

        # Adding field 'Cause.description'
        db.add_column('causes_cause', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('causes_cause', 'name')

        # Deleting field 'Cause.description'
        db.delete_column('causes_cause', 'description')
