...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cause.creator'
        db.add_column('causes_cause', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=474, related_name='causes', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Cause.image'
        db.add_column('causes_cause', 'image',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cause.date_added'
        db.add_column('causes_cause', 'date_added',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 9, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cause.creator'
        db.delete_column('causes_cause', 'creator_id')

        # Deleting field 'Cause.image'
        db.delete_column('causes_cause', 'image')

        # Deleting field 'Cause.date_added'
        db.delete_column('causes_cause', 'date_added')
