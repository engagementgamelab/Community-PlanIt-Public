...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.db_queries'
        db.add_column('reporting_report', 'db_queries',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Report.time_to_run'
        db.add_column('reporting_report', 'time_to_run',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Report.db_queries'
        db.delete_column('reporting_report', 'db_queries')

        # Deleting field 'Report.time_to_run'
        db.delete_column('reporting_report', 'time_to_run')
    ...
    models = {
        ...
        'reporting.report': {
            'Meta': {'ordering': "('-date_added',)", 'object_name': 'Report'},
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'db_queries': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['instances.Instance']", 'null': 'True', 'blank': 'True'}),
            'time_to_run': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
