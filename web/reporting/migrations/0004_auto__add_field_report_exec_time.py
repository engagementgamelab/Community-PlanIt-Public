...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.exec_time'
        db.add_column('reporting_report', 'exec_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Report.exec_time'
        db.delete_column('reporting_report', 'exec_time')
    ...
    models = {
        ...
        'reporting.report': {
            ...
            'exec_time': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
