...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Instance.for_city'
        db.alter_column('instances_instance', 'for_city_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['instances.City']))


    def backwards(self, orm):
        
        # Changing field 'Instance.for_city'
        db.alter_column('instances_instance', 'for_city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['instances.City']))
