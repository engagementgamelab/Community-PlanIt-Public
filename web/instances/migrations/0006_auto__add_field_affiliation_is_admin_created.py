...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Affiliation.is_admin_created'
        db.add_column('instances_affiliation', 'is_admin_created', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Affiliation.is_admin_created'
        db.delete_column('instances_affiliation', 'is_admin_created')
    ...
    models = {
        ...
        'instances.affiliation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_admin_created': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
