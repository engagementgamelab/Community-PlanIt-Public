...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Instance.curator'
        db.delete_column('instances_instance', 'curator_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Instance.curator'
        db.add_column('instances_instance', 'curator', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], null=True, blank=True), keep_default=False)
