...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Affiliation', fields ['slug']
        db.create_unique('instances_affiliation', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Affiliation', fields ['slug']
        db.delete_unique('instances_affiliation', ['slug'])
    ...
    models = {
        ...
        'instances.instance': {
            ...
            'location': ('gmapsfield.fields.GoogleMapsField', [], {'default': "''"}),
