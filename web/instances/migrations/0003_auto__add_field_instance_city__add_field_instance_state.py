...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('instances_instance', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('instances_instance', 'state')
