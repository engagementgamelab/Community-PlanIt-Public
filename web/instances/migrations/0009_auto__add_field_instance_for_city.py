...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Instance.for_city'
        db.add_column('instances_instance', 'for_city', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='instances', to=orm['instances.City']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Instance.for_city'
        db.delete_column('instances_instance', 'for_city_id')
    ...
    models = {
        ...
        'instances.instance': {
            ...
            'for_city': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'instances'", 'to': "orm['instances.City']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
