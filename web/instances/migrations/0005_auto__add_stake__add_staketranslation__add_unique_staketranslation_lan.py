...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Stake'
        db.create_table('instances_stake', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stakes', to=orm['instances.Instance'])),
            ('pos', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('instances', ['Stake'])

        # Adding model 'StakeTranslation'
        db.create_table('instances_staketranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stake', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['instances.Stake'])),
        ))
        db.send_create_signal('instances', ['StakeTranslation'])

        # Adding unique constraint on 'StakeTranslation', fields ['language_code', 'master']
        db.create_unique('instances_staketranslation', ['language_code', 'master_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'StakeTranslation', fields ['language_code', 'master']
        db.delete_unique('instances_staketranslation', ['language_code', 'master_id'])

        # Deleting model 'Stake'
        db.delete_table('instances_stake')

        # Deleting model 'StakeTranslation'
        db.delete_table('instances_staketranslation')
    ...
    models = {
        ...
        'instances.staketranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'StakeTranslation'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': "orm['instances.Stake']"}),
