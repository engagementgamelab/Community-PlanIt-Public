...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InstanceTranslation.name'
        db.delete_column('instances_instancetranslation', 'name')


    def backwards(self, orm):
        
        # Adding field 'InstanceTranslation.name'
        db.add_column('instances_instancetranslation', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=45), keep_default=False)
