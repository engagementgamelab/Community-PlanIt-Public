...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Instance', fields ['slug']
        db.create_unique('instances_instance', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Instance', fields ['slug']
        db.delete_unique('instances_instance', ['slug'])
