...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Instance.days_for_mission'
        db.add_column('instances_instance', 'days_for_mission', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Instance.days_for_mission'
        db.delete_column('instances_instance', 'days_for_mission')
