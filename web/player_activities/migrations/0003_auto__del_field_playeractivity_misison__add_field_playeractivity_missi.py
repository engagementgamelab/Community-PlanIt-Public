...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlayerActivity.misison'
        db.delete_column('player_activities_playeractivity', 'misison_id')

        # Adding field 'PlayerActivity.mission'
        db.add_column('player_activities_playeractivity', 'mission', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['missions.Mission']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PlayerActivity.misison'
        db.add_column('player_activities_playeractivity', 'misison', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['missions.Mission']), keep_default=False)

        # Deleting field 'PlayerActivity.mission'
        db.delete_column('player_activities_playeractivity', 'mission_id')
