...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('player_activities_playermapactivity', (
            ('playeractivity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['player_activities.PlayerActivity'], unique=True, primary_key=True)),
        ...
        # Deleting field 'PlayerActivity.maxNumMarkers'
        db.delete_column('player_activities_playeractivity', 'maxNumMarkers')

        # Adding field 'PlayerActivity.instructions'
        db.add_column('player_activities_playeractivity', 'instructions', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'PlayerActivity.addInstructions'
        db.add_column('player_activities_playeractivity', 'addInstructions', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'PlayerActivity.maxNumMarkers'
        db.add_column('player_activities_playeractivity', 'maxNumMarkers', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Deleting field 'PlayerActivity.instructions'
        db.delete_column('player_activities_playeractivity', 'instructions')

        # Deleting field 'PlayerActivity.addInstructions'
        db.delete_column('player_activities_playeractivity', 'addInstructions')
    ...
    models = {
        ...
        'player_activities.playerempathyactivity': {
            'Meta': {'object_name': 'PlayerEmpathyActivity', '_ormbases': ['player_activities.PlayerActivity']},
        ...
        'player_activities.playermapactivity': {
            'Meta': {'object_name': 'PlayerMapActivity', '_ormbases': ['player_activities.PlayerActivity']},
