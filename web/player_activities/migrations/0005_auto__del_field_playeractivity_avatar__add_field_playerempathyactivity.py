...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerEmpathyActivity.avatar'
        db.add_column('player_activities_playerempathyactivity', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'PlayerEmpathyActivity.bio'
        db.alter_column('player_activities_playerempathyactivity', 'bio', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlayerEmpathyActivity.avatar'
        db.delete_column('player_activities_playerempathyactivity', 'avatar')

        # Changing field 'PlayerEmpathyActivity.bio'
        db.alter_column('player_activities_playerempathyactivity', 'bio', self.gf('django.db.models.fields.CharField')(max_length=255))
