...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerActivity.type'
        db.add_column('player_activities_playeractivity', 'type', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['player_activities.PlayerActivityType']), keep_default=False)

        # Adding field 'PlayerActivity.points'
        db.add_column('player_activities_playeractivity', 'points', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlayerActivity.type'
        db.delete_column('player_activities_playeractivity', 'type_id')

        # Deleting field 'PlayerActivity.points'
        db.delete_column('player_activities_playeractivity', 'points')
