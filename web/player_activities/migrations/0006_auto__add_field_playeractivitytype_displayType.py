...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerActivityType.displayType'
        db.add_column('player_activities_playeractivitytype', 'displayType', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlayerActivityType.displayType'
        db.delete_column('player_activities_playeractivitytype', 'displayType')
