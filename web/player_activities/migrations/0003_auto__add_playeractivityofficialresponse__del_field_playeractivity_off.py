...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlayerActivityOfficialResponse'
        db.create_table('player_activities_playeractivityofficialresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['player_activities.PlayerActivity'], unique=True)),
            ('response', self.gf('django.db.models.fields.TextField')(default='', max_length=500, blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('player_activities', ['PlayerActivityOfficialResponse'])
        ...
        # Deleting field 'PlayerActivity.official_response'
        db.delete_column('player_activities_playeractivity', 'official_response')

        # Deleting field 'PlayerMapActivity.official_response'
        db.delete_column('player_activities_playermapactivity', 'official_response')

        # Deleting field 'PlayerEmpathyActivity.official_response'
        db.delete_column('player_activities_playerempathyactivity', 'official_response')


    def backwards(self, orm):
        
        # Deleting model 'PlayerActivityOfficialResponse'
        db.delete_table('player_activities_playeractivityofficialresponse')
        ...
        # Adding field 'PlayerActivity.official_response'
        db.add_column('player_activities_playeractivity', 'official_response', self.gf('django.db.models.fields.TextField')(default='', max_length=500, blank=True), keep_default=False)

        # Adding field 'PlayerMapActivity.official_response'
        db.add_column('player_activities_playermapactivity', 'official_response', self.gf('django.db.models.fields.TextField')(default='', max_length=500, blank=True), keep_default=False)

        # Adding field 'PlayerEmpathyActivity.official_response'
        db.add_column('player_activities_playerempathyactivity', 'official_response', self.gf('django.db.models.fields.TextField')(default='', max_length=500, blank=True), keep_default=False)
