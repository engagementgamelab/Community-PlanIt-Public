...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crowd.confirmation_code'
        db.alter_column('crowds_crowd', 'confirmation_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Crowd.confirmation_code'
        raise RuntimeError("Cannot reverse this migration. 'Crowd.confirmation_code' and its values cannot be restored.")
    models = {
        ...
        'crowds.crowd': {
            ...
            'confirmation_code': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
