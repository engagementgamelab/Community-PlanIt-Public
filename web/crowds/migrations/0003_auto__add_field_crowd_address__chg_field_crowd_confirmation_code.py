...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Crowd.address'
        db.add_column('crowds_crowd', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'Crowd.confirmation_code'
        db.alter_column('crowds_crowd', 'confirmation_code', self.gf('django.db.models.fields.CharField')(max_length=255))
    def backwards(self, orm):
        # Deleting field 'Crowd.address'
        db.delete_column('crowds_crowd', 'address')
