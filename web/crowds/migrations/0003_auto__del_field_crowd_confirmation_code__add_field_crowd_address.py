...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Crowd.confirmation_code'
        db.delete_column('crowds_crowd', 'confirmation_code')
    ...
    def backwards(self, orm):
        # Adding field 'Crowd.confirmation_code'
        db.add_column('crowds_crowd', 'confirmation_code',
