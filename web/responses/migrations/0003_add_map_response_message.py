...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MapResponse.message'
        db.add_column('responses_mapresponse', 'message', self.gf('django.db.models.fields.CharField')(default=' ', max_length=1000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MapResponse.message'
        db.delete_column('responses_mapresponse', 'message')
