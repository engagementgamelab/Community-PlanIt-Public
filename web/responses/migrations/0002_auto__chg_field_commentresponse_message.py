...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommentResponse.message'
        db.alter_column('responses_commentresponse', 'message', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'CommentResponse.message'
        db.alter_column('responses_commentresponse', 'message', self.gf('django.db.models.fields.CharField')(max_length=260))
